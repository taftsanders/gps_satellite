...
def main():
    if os.geteuid() == 0:
        ...
        satApi = ApiCall(args.hostname, args.username, args.password)
        pulpApi = pulp.Pulp_api(satApi.hostname, path=FULL_PATH)

        if args.all:
            ###########################
            #####INDEPENDENT CALLS#####
            ###########################
            satApi.organization_list()
            satApi.organization_details()
            satApi.location_list()
            satApi.capsule_list()
            satApi.dashboard_details()
            satApi.domain_list()
            satApi.errata_list()
            satApi.openscap_policy_list()
            satApi.satellite_tasks_summary()
            satApi.hammer_ping()
            satApi.realms_list()
            satApi.user_roles_list()
            satApi.settings_list()
            satApi.subnets_list()
            satApi.user_list()
            satApi.arch_list()
            satApi.audit_list()
            satApi.autosign_list()
            satApi.bookmark_list()
            satApi.common_parameters_list()
            satApi.compute_profiles()
            satApi.compute_resources()
            satApi.config_groups()
            satApi.config_reports()
            satApi.config_templates()
            satApi.containers_list()
            satApi.discovered_hosts()
            satApi.discovery_rules()
            satApi.user_role_filters()
            satApi.arf_reports()
            satApi.openscap_contents()
            satApi.gpgkey_list()
            satApi.rex_history_list()
            satApi.os_list()
            satApi.ostree_branches_list()
            satApi.permissions_list()
            satApi.recurring_logics()
            satApi.docker_registries()
            satApi.rex_features_list()
            satApi.reports_list()
            satApi.smart_proxy_list()
            satApi.smart_variables_list()
            satApi.statistics()
            satApi.template_kind_list()
            satApi.usergroup_list()
            satApi.contentview_filters()
            satApi.contentview_versions()
            satApi.docker_manifests()
            satApi.docker_tags()
            satApi.fact_values()
            satApi.smart_proxies_list()
            #############################
            #####DEPENDENT CALLS#########
            #############################
            satApi.activation_key_list()
            satApi.auth_source_ldap_list()
            satApi.content_views_list()
            satApi.puppet_environments_list()
            satApi.host_collection_list()
            satApi.hostgroups_list()
            satApi.hosts_lists()
            satApi.rex_templates_list()
            satApi.lce_list()
            satApi.media_list()
            satApi.products_list()
            satApi.provisioning_templates_list()
            satApi.partition_tables_list()
            satApi.subscription_list()
            satApi.manifest_history()
            satApi.sync_plan_list()
            satApi.uebercert_list()
            satApi.capsule_lce_assigned_list()
            satApi.capsule_lce_available_list()
            satApi.capsule_sync_status_list()
            satApi.cr_avail_img_list()
            satApi.cv_filter_list()
            satApi.cv_history_list()
            satApi.cv_puppet_modules_list()
            satApi.override_values_list()
            satApi.host_details()
            pulpApi.get_task(FULL_PATH)
            pulpApi.get_consumers(FULL_PATH)
            pulpApi.get_orphaned_repos(FULL_PATH)
            pulpApi.get_repositories(FULL_PATH)
            satApi.clean_up()
            satApi.rhst_upload()
        elif args.errata:
            satApi.errata_list()
